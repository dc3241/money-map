...
const Budgets: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto overflow-x-hidden bg-gradient-to-br from-gray-50 via-slate-50/50 to-gray-100 min-h-screen w-full max-w-full min-w-0">
