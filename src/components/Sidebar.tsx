...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, isMobileMenuOpen = false, onMobileMenuToggle }) => {
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-slate-100 rounded-lg shadow-lg"
